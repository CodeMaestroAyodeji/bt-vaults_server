...
} = require('../../controllers/torrents/controllers/torrentController');
const { fetchFiles, deleteFile, downloadFile, zipFiles } = require('../../controllers/torrents/controllers/fileController');
const upload = require('../../middleware/middlewares/uploadMiddleware');
